            ...
            <div className='flex flex-auto flex-col gap-1'>
                <div className='hidden sm:flex items-center justify-between'>
                    ...
                    <div className='text-right flex flex-col gap-y-4'>
                        <Button gradientDuoTone="cyanToBlue" onClick={() => navigate(`${path.CV}/${path.CV__CREATE}`)}>Xem hồ sơ</Button>
                        <div className='flex gap-x-4  items-center justify-between'>
                            <Button color="gray" size='xs' pill> <FaRegEdit size={15} className='mr-2' /> Sửa</Button>
                            <Button color="gray" size='xs' pill> <MdDelete size={15} className='mr-2' /> Xóa</Button>
                        </div>
                    </div>
                </div>
