...
const EmployerLogoCard = ({ data = {} }) => {
    ...
    return (
        <div
            className="dark:bg-slate-800 h-full bg-white rounded-xl shadow-md dark:shadow-lg overflow-hidden border border-gray-200 relative cursor-pointer transition-transform duration-300 ease-in-out hover:scale-90 sm:hover:scale-110 flex flex-col justify-between"
        ...
        >
            ...
            {/* Location */}
            <div className="flex items-center p-4 bg-[#f7f7f7] dark:bg-slate-800">
