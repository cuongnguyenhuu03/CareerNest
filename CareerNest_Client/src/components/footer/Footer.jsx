                    ...
                    <div className="items-start gap-6 md:gap-8 lg:flex 2xl:gap-24">
                        <div className="grid min-w-0 flex-1 grid-cols-2 gap-6 md:gap-8 xl:grid-cols-3">
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Giới thiệu </a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Liên hệ hợp tác </a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Điều khoản dịch vụ </a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white"> Chính sách bảo mật </a>
                                    </li>
                            ...
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Quản lý CV</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Tìm kiếm việc làm</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Bí quyết tìm việc</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Tuyển dụng nhân sự</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Review CV</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                ...
                                <ul className="space-y-3">
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Việc làm tốt nhất</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Việc làm lương cao</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Việc làm IT</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Việc làm Senior</a>
                                    </li>
                                    <li>
                                        <a href="#" title className="text-gray-500 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white">Việc làm bán thời gian</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                        ...
                        <div className="mt-6 w-full md:mt-8 lg:mt-0 lg:max-w-lg">
                            <div className="space-y-5 rounded-lg bg-gray-100 p-6 dark:bg-gray-700">
                                <a href="#" title className="text-base font-medium text-primary-700 no-underline hover:underline dark:text-primary-500"> Đăng nhập hoặc Tạo tài khoản mới ? </a>
