...
const OnlineCV = () => {
    return (
        <div className='w-full flex flex-col gap-y-4 shadow-md dark:shadow-lg p-4 rounded-lg mb-6 dark:bg-gray-700'>
            <Badge className='w-fit text-sm sm:text-lg' color="success" size='sm'>CV online của bạn trên CareerNest</Badge>
            <div className='w-full flex gap-x-3 rounded-lg bg-[#f7f7f7] dark:bg-gray-700 p-2 xs:p-6 border border-gray-200 dark:border-gray-600'>
