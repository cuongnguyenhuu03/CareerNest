...
const RecruitmentComment = ({ companyId = null }) => {
    ...
    const { res, isLoading, isFetching, error, refetch } = useComments(+companyId, +currentPage);
    ...
    return (
        <div className="w-full flex flex-col gap-4">
            {dataComments?.length <= 0 && <Badge color="gray" size="sm" className='w-fit uppercase'>Chưa có bài đánh giá nào.</Badge>}
                    ...
                    <article key={item?.id} className="p-6 mb-6 text-base rounded-lg bg-white border border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                        <div className="flex justify-between items-center mb-2">
                            <div className="flex items-center">
                                <p className="flex items-center mr-6 font-semibold text-sm text-gray-900 dark:text-white">
                                    <Avatar
