...
import { FooterToolbar, ModalForm, ProFormDatePicker, ProFormText, ProFormTextArea, ProFormSelect } from "@ant-design/pro-components";
            ...
            >
                <Row gutter={16}>
                    ...
                    {selectedRole === 2 && (
                        <Col span={12}>
                            <ProFormSelect
                                label="Thuộc công ty"
                                name="company"
                                rules={[{ required: true, message: 'Vui lòng không bỏ trống' }]}
                                options={[
                                    { label: "Công ty A", value: "company_a" },
                                    { label: "Công ty B", value: "company_b" },
                                ]}
